...
public class AssistantTutorialCreateTest extends TestHarness {
	...
	public void test100Positive(final int tutorialRecordIndex, final String assistant, final String code, final String title, final String abstractTutorial, final String goals) {
