...
<acme:form>
	...
	<acme:input-textbox code="assistant.tutorial-session.form.label.sessionType" path="sessionType"/>
	<acme:input-moment code="assistant.tutorial-session.form.label.startPeriod" path="startPeriod"/>
